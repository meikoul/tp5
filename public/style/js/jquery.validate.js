 ...
 *
 * Copyright (c) 2006 - 2014 Jörn Zaefferer
 *
...
$.extend($.validator, {
	...
	methods: {
		...
		english: function(value, element) {
			return this.optional(element) || /^[a-z_A-Z]+$/.test(value);
		},
		en_num: function(value, element) {
		...
		cn_username: function(value, element) {
			return this.optional(element) || /^([\u4e00-\u9fa5]|[\w])+$/.test(value);
		},
		tel: function(value, element) {
			return this.optional(element) || /^[+]{0,1}(\d){1,4}[ ]{0,1}([-]{0,1}((\d)|[ ]){1,12})+$/.test(value);
		},
...
if(window.LANG && LANG=='en'){
	jQuery.extend(jQuery.validator.messages, {
		...
		maxlength: jQuery.validator.format("Please enter a string length up to  {0} "),
		minlength: jQuery.validator.format("Please enter a string length is at least {0} "),
		rangelength: jQuery.validator.format("Enter a length of string between {0} and {1}"),
		...
		ip4:  "Please enter a correct IP address",
		mobile: "Please enter a correct phone number",
		zipcode: "Please enter the correct zip code",
		qq: "Please enter a correct QQ number",
		idcard: "Please enter the correct id number",
		chinese: "Please input Chinese characters",
		cn_username:"Please enter in English and in Chinese",
		tel: "Please enter a correct phone number",
		english: "Can only input English letters",
		en_num: "Can only input English and Numbers and the underscore"
	});
} 
